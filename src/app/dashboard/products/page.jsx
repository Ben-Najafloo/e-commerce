        ...
        <div>
            <div className='px-2 lg:px-9 pt-2'>
                ...
                {!products ? (
                    ...
                    <div className="flex-1 overflow-y-auto lg:px-4 py-6 sm:px-6 border-t border-gray-200">
                        <div className="mt-1">
                            <div className="flow-root">
                                <ul role="list" className="-my-6 divide-y divide-gray-200">
                                    <li className="flex py-2">
                                        <div className="hidden sm:block size-12 shrink-0 overflow-hidden rounded-md border border-gray-200">
