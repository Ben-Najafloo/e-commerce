            ...
            <section className="relative pt-24">
                <div className="w-full mx-auto px-4 sm:px-6 lg:px-0">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mx-auto max-md:px-2 ">
                        <div className="img">
                            <div className="img-box h-full max-lg:mx-auto p-2">
                        ...
                        <div
                            ...
                            <div className="data w-full max-w-xl">
                                <Link href={`http://localhost:3000/?category=${product.category}#products`}
                                    className="text-lg font-medium leading-8 text-indigo-600 mb-4">
                                    {product.category}
                                </Link>
                                <h2 className="font-manrope font-bold text-3xl leading-10 text-gray-500 mb-2 capitalize">
                                    {product.title}
                                </h2>
                                <div className="flex flex-col sm:flex-row sm:items-center mb-6">
                                    <h6 className="font-manrope font-semibold text-2xl leading-9 text-gray-600 pr-5 sm:border-r border-gray-200 mr-5">
                                        ${product.price}
                                    </h6>
                                    <div className="flex items-center gap-2">
                                        ...
                                        {/* <span className="pl-2 font-normal leading-7 text-gray-400 text-sm ">Rate: {product.rating.rate}</span> */}
                                    </div>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <button
                                        ...
                                        className="group py-4 px-5 rounded-full bg-indigo-100 text-indigo-600 font-semibold text-lg w-full flex items-center justify-center gap-2 transition-all duration-500 hover:bg-indigo-100">
                                ...
                                <Link href='/'
                                    className="mt-4 text-center w-full px-3 py-2 rounded-2xl bg-gray-400 flex items-center justify-center text-lg text-black shadow-sm transition-all duration-500 hover:bg-indigo-700 hover:shadow-indigo-400">
                                    &larr; Back
                                </Link>
                            </div>
                        </div>
